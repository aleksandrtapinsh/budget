export default function TransactionFilter({ filters, budgets, onChange }) {
  ...
  const inputCls = 'bg-gray-700 border border-gray-600 text-gray-200 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 placeholder:text-gray-500';
  ...
  return (
    <div className="flex flex-wrap gap-2 my-4 items-center">
      ...
      <button onClick={() => onChange({})} className="text-sm text-gray-400 hover:text-gray-200 px-3 py-1.5 bg-gray-700 hover:bg-gray-600 rounded-lg">
        Clear
      </button>
    </div>
  );
